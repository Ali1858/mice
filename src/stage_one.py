...
# Local imports
from src.masker import Masker, RandomMasker, GradientMasker, VMasker
...
def get_stage_one_masker(args, predictor):
    ...
    elif args.mask.mask_type == "vmask":
        logger.info("Loading VMask ...")
        masker = VMasker(None, editor_tokenizer_wrapper, predictor, 
                args.model.model_max_length,) #TODO create the class
    logger.info("Done.")
    return masker
